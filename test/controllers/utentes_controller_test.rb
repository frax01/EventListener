...
class UtentesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create utente" do
    assert_difference("Utente.count") do
      post utentes_url, params: { utente: { cognome: @utente.cognome, data_di_nascita: @utente.data_di_nascita, id: @utente.id, mail: @utente.mail, nome: @utente.nome, password: @utente.password } }
    end
  ...
  test "should update utente" do
    patch utente_url(@utente), params: { utente: { cognome: @utente.cognome, data_di_nascita: @utente.data_di_nascita, id: @utente.id, mail: @utente.mail, nome: @utente.nome, password: @utente.password } }
