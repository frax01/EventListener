...
class RadunosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create raduno" do
    assert_difference("Raduno.count") do
      post radunos_url, params: { raduno: { data: @raduno.data, descrizione: @raduno.descrizione, email: @raduno.email, luogo: @raduno.luogo, nome_darte_organizzatore: @raduno.nome_darte_organizzatore, orario: @raduno.orario } }
    end
  ...
  test "should update raduno" do
    patch raduno_url(@raduno), params: { raduno: { data: @raduno.data, descrizione: @raduno.descrizione, email: @raduno.email, luogo: @raduno.luogo, nome_darte_organizzatore: @raduno.nome_darte_organizzatore, orario: @raduno.orario } }
